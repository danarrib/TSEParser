...
namespace org.bn.metadata
{
    ...
    public class ASN1OctetStringMetadata : ASN1FieldMetadata
    {
        public ASN1OctetStringMetadata() {
            
        }
        
        public ASN1OctetStringMetadata(String name): base(name)
        {
        }
        ...
        {
            return encoder.encodeOctetString(obj, stream, elementInfo);
        }
