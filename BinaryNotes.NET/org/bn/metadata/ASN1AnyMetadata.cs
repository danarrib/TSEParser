...
namespace org.bn.metadata
{
    ...
    public class ASN1AnyMetadata : ASN1FieldMetadata
    {
        public ASN1AnyMetadata(String name): base(name)
        {
            
        }
        
        public ASN1AnyMetadata(ASN1Any annotation): this(annotation.Name) {
            ;
        }
